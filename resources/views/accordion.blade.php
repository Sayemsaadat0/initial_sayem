                    ...
                    <div class="content">
                        <ul class="py-2 space-y-2">
                            ...
                            <li>
                                <button type="button"
                                    class="flex items-center w-full p-2 text-base text-gray-900 transition-all duration-700 rounded-lg group hover:bg-slate-100/20"
                                    aria-controls="dropdown-school-admin" data-collapse-toggle="dropdown-school-admin">
                                    <span
                                        class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap text-white">School
                                        Admin</span>
                                ...
                                <div class="sub-content">
                                    <ul class="py-2 space-y-2">
                                        ...
                                        <!-- Add more sub-accordion items if needed -->
                                    </ul>
                                </div>
                            </li>
                        </ul>
